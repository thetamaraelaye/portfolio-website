const TechnicalWriting = () => {
  ...
  return (
    <section id="technical-writing" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-bold mb-8 text-center">Technical Writing</h2>
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {articles.map((a) => (
            <div key={a.title} className="p-6 border rounded-lg hover:shadow-lg">
              ...
              <div className="flex gap-4">
                <a href={a.link} target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">Read article</a>
                {a.github && (
