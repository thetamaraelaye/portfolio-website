...
const InternalTools = () => {
  const tools = [
    {
      title: "Sense AI Dashboard",
      desc: "Internal dashboard to the National hotline requests and route support for smallholder farmers.",
      skills:  ["React", "TypeScript", "Axois", "Redux", "TailwindCSS"],
      details: "Advanced internal dashboard system for monitoring and managing toll-free agricultural support hotline. Features real-time request tracking, automated routing to support agents, performance analytics, and integration with AI-powered response systems. Built to handle high-volume farmer inquiries across multiple regions.",
      achievements: [
    ...
    {
      title: "Project SCM ",
      desc: "Supply chain management application for project thesis (Grade: A).",
      skills: ["Next.js", "TailwindCSS", "Node.js", "Express.js", "MongoDB", ],
